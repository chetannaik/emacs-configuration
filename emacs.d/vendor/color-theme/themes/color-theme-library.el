	...
	(interactive)
	  (color-theme-install
	   '(color-theme-hacker
	      ...
	      (border-color . "#75ffd6")
	      (cursor-color . "#4ffcd0")
	      (foreground-color . "#00bdb2")
	      (mouse-color . "black"))
	     (fringe ((t (:background "#75ffd6"))))
	     (mode-line ((t (:foreground "#000000" :background "#80ffee"))))
	     (region ((t (:background "#0d4519"))))
	     (font-lock-builtin-face ((t (:foreground "#86a4ee"))))
	     (font-lock-comment-face ((t (:foreground "#808080"))))
	     (font-lock-function-name-face ((t (:foreground "#ed7000"))))
	     (font-lock-keyword-face ((t (:foreground "#00e069"))))
	     (font-lock-string-face ((t (:foreground "#bf66ff"))))
	     (font-lock-type-face ((t (:foreground"#fe4872"))))
	     (font-lock-variable-name-face ((t (:foreground "#eeeeec"))))
	     (minibuffer-prompt ((t (:foreground "#38d5ff" :bold t))))
	     (font-lock-warning-face ((t (:foreground "Red" :bold t))))
	     )))
(provide 'color-theme-hacker)
